main: main.cpp loaders.cpp
	g++ main.cpp loaders.cpp setups.cpp input.cpp audio.cpp render.cpp acoes.cpp texto.cpp dr_wav.c ./glad/src/glad.c ./include/tiny_obj_loader.h ./include/stb_image.h -o t.elf -std=c++11 -Wall -I./glad/include -I./include -I./include/freetype -lGL -lGLU -lGLEW -lglfw -ldl -lfreetype -lopenal -lpthread
