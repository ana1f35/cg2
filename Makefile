main: main.cpp
	g++ main.cpp ./glad/src/glad.c ./include/tiny_obj_loader.h ./include/stb_image.h -o t.elf -std=c++11 -Wall -I./glad/include -lGL -lGLU -lGLEW -lglfw -ldl -lfreetype -lopenal -lpthread
